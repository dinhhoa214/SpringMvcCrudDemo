...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/resources/bootstrapValidator.css"/>" type="text/css" />	 
     
    <script type="text/javascript" src="<c:url value="/resources/jquery/jquery.min.js"/>"></script>
    <script type="text/javascript" src="<c:url value="/resources/jquery/bootstrap.min.js"/>"></script>
    <script type="text/javascript" src="<c:url value="/resources/jquery/bootstrapValidator.js"/>">
    </script> 
</head>
<body>
    <div class="container">
